...
function AboutUs() {
  useEffect(() => {
    document.title = "Makati Human Milk Bank - About Us";
  }, []);
    ...
    <div className="about-page-wrapper">
      ...
      <div className="about-content-grid">
        ...
        <div className="about-images-container">
          <img src="/images/image10.png" alt="Medical staff assisting patient" />
          <img src="/images/image11.png" alt="Mother and baby" />
          <img src="/images/image12.png" alt="Staff processing milk" />
        </div>
